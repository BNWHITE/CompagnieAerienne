...
/**
 * Service de persistance des données via une base de données relationnelle
 * <b>H2</b>.
 *
 * <p>
 * Utilise l'API <b>JDBC</b> ({@link java.sql}) pour communiquer avec une base
 * de données embarquée H2. La base est créée automatiquement si elle n'existe
 * pas.
 * </p>
 *
 ...
 * <li>{@link java.sql.Statement} / {@link java.sql.PreparedStatement} —
 * exécuter des requêtes SQL</li>
 * <li>{@link java.sql.ResultSet} — parcourir les résultats d'une requête
 * SELECT</li>
 * </ul>
 *
...
public class DatabaseService {
     ...
     *
     * <p>
     * Utilise {@link DriverManager#getConnection(String, String, String)}.
     * </p>
     *
     ...
     *
     * <p>
     * Utilise {@link Statement#execute(String)} pour exécuter du DDL
     ...
     *
     * <p>
     * Utilise un {@link PreparedStatement} pour éviter les injections SQL.
     * </p>
     *
     ...
     * @param typeVol     type de vol ({@code "Court Courrier"},
     *                    {@code "Moyen Courrier"}, {@code "Long Courrier"})
     ...
     *
     * <p>
     * Utilise {@link ResultSet} pour parcourir les lignes retournées.
     * </p>
     *
